 ...
 * lists.
 * <p>
 * CANL modification: expose underlying base selector.
 * @see org.bouncycastle.util.Selector
 */
public class PKIXCRLStoreSelectorCanl<T extends CRL>
    implements CRLSelector, Selector<CRL>
{
    public static class Builder
    {
        ...
        public PKIXCRLStoreSelectorCanl<? extends CRL> build()
        {
            return new PKIXCRLStoreSelectorCanl(this);
        }
    }
    ...
    private PKIXCRLStoreSelectorCanl(Builder baseBuilder)
    {
    ...
    public CRLSelector getBaseSelector()
    {
	    return baseSelector;
    }
    ...
    public static Collection<? extends CRL> getCRLs(final PKIXCRLStoreSelectorCanl<?> selector, CertStore certStore)
        throws CertStoreException
    {
        return certStore.getCRLs(selector);
    }
}
